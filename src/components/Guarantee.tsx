      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="space-y-6 sm:space-y-8 animate-slide-up order-2 lg:order-1" style={{animationDelay: '0.2s'}}>
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-lg border">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl sm:text-2xl font-bold text-gray-800">Risco Zero</h3>
                    <p className="text-green-600 font-medium text-sm sm:text-base">Sua satisfação garantida</p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-4 sm:p-6 border border-blue-200">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-700 text-sm sm:text-base">Adquira o guia hoje</p>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-700 text-sm sm:text-base">Teste por 7 dias completos</p>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-700 text-sm sm:text-base">Não gostou? Devolvemos 100% do valor</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center animate-scale-in order-1 lg:order-2" style={{animationDelay: '0.4s'}}>
              ...
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border">
                ...
                <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-4 sm:p-6 mb-6">
                  <div className="flex items-center justify-center gap-3 mb-3">
                    <Clock className="w-6 h-6 text-green-600" />
                    <span className="text-base sm:text-lg font-semibold text-gray-800">Oferta por tempo limitado</span>
                  </div>
                ...
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg font-semibold rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 w-full group"
                >
