  ...
  const steps = [
    {
      ...
      description: "Identifique o perfil do seu bebê e as principais causas dos problemas de sono",
      time: "Dia 1"
    },
    {
      number: "2", 
      ...
      description: "Configure o quarto e crie a atmosfera perfeita para noites tranquilas",
      time: "Dias 2-3"
    },
    {
      number: "3",
      icon: Clock,
      title: "Implementação da rotina",
      description: "Estabeleça horários e rituais que funcionam para sua família",
      time: "Dias 4-5"
    },
    {
      number: "4",
      icon: Sparkles,
      title: "Ajustes e resultados",
      description: "Faça os últimos ajustes e celebre suas primeiras noites de paz",
      time: "Dias 6-7"
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Um plano estruturado de 7 dias para transformar completamente as noites da sua família
          </p>
        </div>
            ...
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-700">das mães veem melhora já na primeira semana</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-accent-600 mb-2">6-8h</div>
                  <p className="text-gray-700">de sono ininterrupto por noite</p>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-green-600 mb-2">97%</div>
                  <p className="text-gray-700">recomendariam o método para outras mães</p>
                </div>
              </div>
            </div>
          </div>
